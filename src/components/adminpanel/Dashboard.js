...
const MainContent = styled.div`
  ...
  color: ${(props) => (props.$isDarkMode ? "red" : "#000")};
`;
...
function Dashboard() {
  ...
  const tableData = [
    {
      id: 1,
      username: "Bhavesh Modani",
      email: "bhaveshmodani@gmail.com",
      role: "Admin",
    ...
    {
      id: 2,
      username: "Tanisha Mohta",
      email: "mohtatanisha@gmail.com",
      role: "Moderator",
    ...
    {
      id: 3,
      username: "Chirag Dave",
      email: "davecr@gmail.com",
      role: "User",
      permission: "Read",
    ...
    {
      id: 4,
      username: "VRV Securites",
      email: "vrvsecurities@gmail.com",
      role: "Manager",
    ...
    {
      id: 5,
      username: "Dhruv Chopkar",
      email: "dhruv.chopkar@gmail.com",
      role: "User",
      permission: "Read",
    ...
    {
      id: 6,
      username: "Parth kasat",
      email: "pbkasat@gmail.com",
      role: "Moderator",
      permission: "Read, Delete",
